<?php
	...
	if ((!($z_time == "")) && ($permission == "0")) {
		$z_ms .= "<p>昨日までの未承認の残業時間が".round($un_zangyou_time * 60)."分あります<br>";
		$z_ms .= "<a href='/kanri/zangyou/zangyou_kanri.php'><button class='kbt'>残業申請リスト</button></a></p>";
	}
	// 基本給
	//仮 給与区分【月給・時給・日給】
	//仮で小数点以下四捨五入
	...
	$kyuyo_data .= "<div id='kyuyo_data' style='padding: 10px; margin-bottom: 10px; border: 1px solid #333333; border-radius: 10px; width:300px;'>";
	$kyuyo_data .= "社員番号：".$s_no."　名前：".$name."<br>".$shift_ym."月度　";
	$kyuyo_data .= "給与区分【".$kubun."】<br>基本給【".number_format($k_tanka)."】<br>残業代【".number_format($z_tanka)."】</div>";
