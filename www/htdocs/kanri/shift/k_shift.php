<?php
	...
	if (isset($s_id)) {
		$shift_data .= "<table id='shift_data' class='shift_data' ><th class='thname'>名前</th>".$date.$shift_time."</table>";
		$shift_data .= "<p>修正したいシフトがある場合は該当する<br>シフトコードをクリックしてください</p>";
	} else {
		$shift_data .="今月度のシフトはまだありません";
	}
...
<body>
	...
	<div>
		<h2>シフト一覧</h2>
		<p><a href= "k_shift_list.php?m_shift=<?php echo $l_y_month;?>" ><?php echo $l_y_month ?>月度≪</a>　<?php echo $y_month; ?>月度シフト
		　<a href= "k_shift_list.php?m_shift=<?php echo $n_y_month;?>">≫<?php echo $n_y_month ?>月度</a>　
		<a href= "shift_past.php"><button class='kbt'>過去シフト 検索</button></a></p>
<?php echo $shift_data;  ?>
